...
export function TufOverviewScreen() {
  ...
  return <QueryStateView isLoading={query.isLoading} isError={query.isError} isEmpty={!player}
    error={query.error} onRetry={() => void query.refetch()} emptyText="请在游戏管理中绑定 TUF 玩家"
    data={player ? payload : undefined} renderData={() => <ScrollView contentInsetAdjustmentBehavior="automatic"
