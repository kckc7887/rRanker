...
describe('achievement tolerance', () => {
  it('calculates normal-note and mixed judgments deterministically', () => {
    ...
    expect(maximumSameErrors(notes, 99, 'tap', 'great')).toBe(5);
  });
  ...
  it('handles empty charts and rejects BREAK calculations without BREAK notes', () => {
    expect(calculateAchievement({ tap: 0, hold: 0, slide: 0, touch: 0, break: 0 }, {})).toBe(0);
